  ...
  useEffect(() => {
    const fetchRecipes = async () => {
      try {
        ...
        const chineseRecipes = response.data.filter(recipe => recipe.category === "Chinese");
    ...
    <section className="page-recipes pb-4 pt-4">
      <nav aria-label="breadcrumb">
        <ol className="breadcrumb">
          ...
          <li className="breadcrumb-item active" aria-current="page">Chinese Recipes</li>
        </ol>
      </nav>

      <div className='mb-5'>
        <h2 className="search-results-heading page-recipes-heading animated">
          <FaUtensilSpoon className="search-icon" /> {/* Replace with your chosen icon */}
          Chinese Recipes
...
export default ChineseRecipesPage;