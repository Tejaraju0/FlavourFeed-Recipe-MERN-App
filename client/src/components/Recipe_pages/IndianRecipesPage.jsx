  ...
  useEffect(() => {
    const fetchRecipes = async () => {
      try {
        ...
        const indianRecipes = response.data.filter(recipe => recipe.category === "Indian");
    ...
    <section className="page-recipes pb-4 pt-4">
      ...
      <div className='mb-5'>
        <h2 className="search-results-heading page-recipes-heading animated">
          <FaFire className="search-icon" /> {/* Replace with your chosen icon */}
          Indian Recipes
